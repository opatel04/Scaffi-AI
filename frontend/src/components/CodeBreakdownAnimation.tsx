            ...
            <div className="rounded-2xl border border-gray-200/60 dark:border-gray-800/60 bg-white dark:bg-black p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 p-1 rounded-lg bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
                  <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-medium bg-white dark:bg-gray-800 text-black dark:text-white shadow-sm">
                    <Type className="h-4 w-4" />
                    Enter Text
                  </button>
                  <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-medium text-gray-600 dark:text-gray-400">
              ...
              <div className="space-y-4">
                <div className="text-center mb-6">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    This may take 20-40 seconds depending on assignment
                    complexity
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        Creating starter code across 3 files ({tasksCompleted}/{tasksTotal}{" "}
                        tasks)
                      </p>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs mt-0.5 text-green-700 dark:text-green-300">
                          Your scaffold is ready - 3 files generated
                        </p>
                      </div>
                    </div>
                  )}
        ...
        <div className="h-full grid grid-cols-3 divide-x divide-gray-200/60 dark:divide-gray-800/60 animate-fade-in relative">
          ...
          <div className="col-span-2 flex flex-col h-full bg-white dark:bg-black">
            <div className="flex-1 overflow-auto p-4">
              {/* File Tabs */}
              <div className="flex items-center gap-1 mb-4 border-b border-gray-200/60 dark:border-gray-800/60 pb-2">
                <button className="px-3 py-1.5 rounded-t-lg bg-white dark:bg-black border-t border-x border-gray-200/60 dark:border-gray-800/60 text-xs font-medium text-black dark:text-white flex items-center gap-2">
                  <FileText className="h-3 w-3" />
                  validation.js
                </button>
                <button className="px-3 py-1.5 rounded-t-lg text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 flex items-center gap-2">
                  <FileText className="h-3 w-3" />
                  server.js
                </button>
                <button className="px-3 py-1.5 rounded-t-lg text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 flex items-center gap-2">
              ...
              {/* Download Section */}
              <div className="flex items-center gap-2 mt-4 pt-4 border-t border-gray-200/60 dark:border-gray-800/60">
                <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gradient-to-r from-green-600 to-green-500 text-white text-xs font-medium shadow-sm hover:from-green-700 hover:to-green-600">
                  <Download className="h-3 w-3" />
                  Download All Files
                </button>
                <span className="text-xs text-gray-500 dark:text-gray-400">3 files ready</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 flex flex-col h-full bg-white dark:bg-black border-l border-gray-200/60 dark:border-gray-800/60">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4">
              {showHint ? (
                ...
                >
                  <div
                    className="rounded-lg p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 animate-slide-in"
                    style={{
